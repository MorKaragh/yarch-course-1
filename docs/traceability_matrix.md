...
| Авторизация | Ф-2 | Определение прав досупа пользователя (админ/не админ) | Обязательно | Отдел офис-менеджмента | NoName из переписки | Новый | - |
...
| Указание даты бронирования | Ф-4 | Обязательное указывание даты бронирования | Обязательно |||||
| Указание места для бронирования | Ф-5 | Обязательное указывание номера бронируемого парковочного места | Обязательно |||||
| Указание автомобиля для бронирования | Ф-6 | Обязательное указание ГРЗ, цвет, марку автомобиля | Обязательно |||||
...
| Администрирование перечня парковочных мест | Ф-8 | При наличии прав администратора, возможность добавлять и удалять парковочные места из общего перечня | Обязательно |||||
| Просмотр истории бронирований | Ф-9 | При наличии прав администратора, возможность просматривать историю бронирований | Обязательно |||||
| Нотификация пользователя о бронировании | Ф-10 | Предварительное (?срок?) уведомление пользователя о скором начале периода сделанной им брони | Желательно |||||
| Нотификация менеджмента парковки о бронировании | Ф-11 | Раз в сутки вечером, уведомление ответственных за управление парковкой лиц о всех автомобилях, на которых сделана бронь на завтра. Одним email-письмом. | Обязательно |||||
| Администрирование каталога пользователей | Ф-12 | Создание и блокирование УЗ в собственном каталоге пользователей | Обязательно, если не выполнено требование Ф-13 |||||
| Интеграция с корпоративным каталогом пользователей | Ф-13 | Использование корпоративного каталога пользователей вместо внутреннего каталога | Желательно |||||
| Учёт индивидуальных лимитов на бронирование | Ф-14 | Доступность бронирования для пользователя определяется наличием бронирований на балансе пользователя | Обязательно |||||
| Задание лимитов на бронирование | Ф-15 | При наличии прав администратора, возможность редактировать лимиты на бронирование для пользователей | Желательно |||||
